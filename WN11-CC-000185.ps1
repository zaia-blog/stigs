...
Write-Host "`n[STIG] WN11-CC-000185 - Disable Autorun Commands" -ForegroundColor Cyan
...
Write-Host "[PASS] Autorun command execution blocked on this system" -ForegroundColor Green
